  		...
  		<div class="footer-newsletter">
  			<div class="container">
  				<div class="row justify-content-center">
  					<div class="col-lg-6">
  						<h4>Cari Aspirasi</h4>
  						<p>Temukan status terakhir aspirasi Anda dengan memasukkan Nomor Tiket aspirasi.</p>
  	...
  	<section id="about" class="about">
  		<div class="container" data-aos="fade-up">
  			...
  			<div class="row content">
  				<div class="col-lg-6">
  					<p>
  						Sistem WBS merupakan wadah dimana pengguna dapat menyalurkan Masukan yang terkait dengan Politeknik Caltex
  						Riau. Sistem ini
  						diharapkan dapat menjadi media untuk menyalurkan Masukan berupa Aspirasi, Saran, Permohonan Informasi dan
  						Lapor Pelangaran.
  					</p>
  					<ul>
  						<li><i class="ri-check-double-line"></i> Aspirasi</li>
  						<li><i class="ri-check-double-line"></i> Saran</li>
  						<li><i class="ri-check-double-line"></i> Pelaporan Pelanggaran</li>
  						<li><i class="ri-check-double-line"></i> Permohonan Informasi</li>
  					</ul>
  				</div>
  		...
  		<div class="container" data-aos="fade-up">
  			...
  			<div class="row">
  				...
  				<div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
  					<h3>Jumlah Laporan yang masuk</h3>
  					<p class="font-italic">
  						Jumlah Laporan yang masuk berdasarkan Jenisnya
  					</p>

  					<div class="skills-content">

  						<div class="progress">
  							<span class="skill">Aspirasi <i class="val">100%</i></span>
  						...
  						<div class="progress">
  							<span class="skill">Saran <i class="val">90%</i></span>
  							<div class="progress-bar-wrap">
  						...
  						<div class="progress">
  							<span class="skill">Permohonan Informasi <i class="val">75%</i></span>
  							<div class="progress-bar-wrap">
  						...
  						<div class="progress">
  							<span class="skill">Laporan Pengasduan <i class="val">55%</i></span>
  							<div class="progress-bar-wrap">
  			...
  			<div class="row">
  				<div class="col-xl-3 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
  					<div class="icon-box">
  						...
  						<h4><a href="">Aspirasi</a></h4>
  						<p>Salalurkan Aspirasi Anda Pada Sistem Ini</p>
  					</div>
  				</div>
  				...
  				<div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in"
  					...
  					<div class="icon-box">
  						...
  						<h4><a href="">Permohonan Informasi</a></h4>
  				...
  				<div class="col-xl-3 col-md-6 d-flex align-items-stretch mt-4 mt-xl-0" data-aos="zoom-in"
  					data-aos-delay="400">
  					<div class="icon-box">Pelanggaran</a></h4>
  						<p>At vero eos et accusamus et iusto</p>
  						<div class="icon"><i class="bx bx-layer"></i></div>
  						<h4><a href="">Lapor odio dignissimos ducimus qui blanditiis</p>
  					</div>
  				</div>
  		...
  		<div class="container" data-aos="fade-up">
              ...
              <div class                = "form-row">
                <div class              = "form-group col-md-6">
                  ...
                  <input type           = "text" name="name" class="form-control" id="name" data-rule="minlen:4" data-msg="*Wajib Diisi" />
                  <div class            = "validate"></div>
                </div>
                <div class              = "form-group col-md-6">
                  <label for            = "name">No.Tlpn Pelapor</label>
                  <input type           = "email" class="form-control" name="email" id="email" data-rule="email" data-msg="*Wajib Diisi" />
                  <div class            = "validate"></div>
                </div>
                <div class              = "form-group col-md-6">
                  <label for            = "name">Email Pelapor</label>
                  <input type           = "text" name="name" class="form-control" id="name" data-rule="minlen:4" data-msg="*Wajib Diisi" />
                  <div class            = "validate"></div>
                </div>
              ...
              <div class                = "form-group">
                ...
                <input type             = "text" class="form-control" name="subject" id="subject" data-rule="minlen:4" data-msg="*Wajib diisi" />
                <div class              = "validate"></div>
              </div>
              <div class                = "form-group">
