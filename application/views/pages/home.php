    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>Lapor Yuk !</h1>
          <h2>Berikan Aspirasi, Saran<, LaPOR Pelanggaran dan Permohonan Informasi</h2>
          <div class="d-lg-flex">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          <div class="col-lg-6">
            <p>
              Sistem WBS  merupakan wadah dimana pengguna dapat menyalurkan Masukan yang terkait dengan Politeknik Caltex Riau. Sistem ini 
              diharapkan dapat menjadi media untuk menyalurkan Masukan berupa Aspirasi, Saran, Permohonan Informasi dan Lapor Pelangaran.
            </p>
            <ul>
