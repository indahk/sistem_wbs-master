...
class Md_permintaan extends MX_Controller
{
    ...
    {
        $query = $this->db->query('select * from vw_permintaan'); //mendapatkan seluruh data di tb_aspirasi
