...
<head>
  ...
  <title>Sistem WBS | <?= $page_title ?></title>
...
<div class="wrapper">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="assets/dashboard/dist/img/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="https://dashboardlte.io/docs/3.1/" class="nav-link">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2021 <a href="https://dashboardlte.io">AdminLTE.io</a>.</strong>
    All rights reserved.
...
<!-- AdminLTE App -->
<script src="<? base_url('assets/dashboard/dist/js/dashboardlte.js') ?>"></script>
