              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <ul class="nav nav-pills ml-auto">
                    <li class="nav-item">
                      <a class="nav-link active" href="<?= base_url('') ?>#revenue-chart" data-toggle="tab">Aspirasi</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="<?= base_url('') ?>#sales-chart" data-toggle="tab">Saran</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="<?= base_url('') ?>#sales-chart" data-toggle="tab">Pelaporan</a>
                    </li>
                  </ul>
                </div>
              </div><!-- /.card-header -->
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <ul class="pagination pagination-sm">
                    <li class="page-item"><a href="<?= base_url('') ?>#" class="page-link">&laquo;</a></li>
                    <li class="page-item"><a href="<?= base_url('') ?>#" class="page-link">1</a></li>
                    <li class="page-item"><a href="<?= base_url('') ?>#" class="page-link">2</a></li>
                    <li class="page-item"><a href="<?= base_url('') ?>#" class="page-link">3</a></li>
                    <li class="page-item"><a href="<?= base_url('') ?>#" class="page-link">&raquo;</a></li>
                  </ul>
                </div>
              </div>
              <!-- /.card-header -->
                ...
                <div class="card-tools">
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu" role="menu">
                      <a href="<?= base_url('') ?>#" class="dropdown-item">Add new event</a>
                      <a href="<?= base_url('') ?>#" class="dropdown-item">Clear events</a>
                      <div class="dropdown-divider"></div>
                      <a href="<?= base_url('') ?>#" class="dropdown-item">View calendar</a>
                    </div>
                  </div>
